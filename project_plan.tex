...
\subsection{Phase 1: Research (Weeks 1-2, 40 hours) - COMPLETED}
...
\bibitem{tokio_blog}
Tokio Team (2021) \textit{Announcing io\_uring support for Tokio}. Available at: https://tokio.rs/blog/2021-07-tokio-uring (Accessed: 1 January 2025).

\bibitem{tokio_uring}
Tokio Contributors (2025) \textit{tokio-uring: io\_uring support for Tokio}. GitHub. Available at: https://github.com/tokio-rs/tokio-uring (Accessed: 1 January 2025).

\bibitem{safetensors}
HuggingFace (2024) \textit{Safetensors: Simple, safe way to store and distribute tensors}. GitHub. Available at: https://github.com/huggingface/safetensors (Accessed: 1 January 2025).

\bibitem{iouring_intro}
Axboe, J. (2019) \textit{Efficient IO with io\_uring}. Available at: https://kernel.dk/io\_uring.pdf (Accessed: 1 January 2025).

\bibitem{liburing}
Axboe, J. (2025) \textit{liburing: io\_uring library}. GitHub. Available at: https://github.com/axboe/liburing (Accessed: 1 January 2025).

\bibitem{serverlessllm_repo}
ServerlessLLM Contributors (2024) \textit{ServerlessLLM: Locality-enhanced Serverless Inference for Large Language Models}. GitHub. Available at: https://github.com/ServerlessLLM/ServerlessLLM (Accessed: 1 January 2025).
