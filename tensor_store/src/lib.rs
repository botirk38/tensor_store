...
mod tests {
    ...
    fn test_load_parallel_zero_copy() {
        ...
        tokio_uring::start(async {
            ...
            println!("Zero-copy parallel loading test passed! Loaded {} tensors", tensors.names().len());
        });
    }
    ...
    fn test_load_parallel_zero_copy_io_uring() {
        ...
        tokio_uring::start(async {
            ...
            println!("Zero-copy parallel loading (io_uring) test passed! Loaded {} tensors", tensors.names().len());
        });
    }
}
